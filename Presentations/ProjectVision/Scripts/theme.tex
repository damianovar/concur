...
\defbeamertemplate{note page}{lookahead}
{
	\vskip0.1cm
	\begin{tikzpicture}
		\node (note) [text width = 0.97\textwidth, minimum width = 1.0\textwidth, minimum height = 0.93\textheight, draw, rounded corners, align = justify] {\begin{varwidth}{\linewidth} \insertnote \end{varwidth}};
